...
class MeshGeometry2D:
    ...
    def from_gambit_and_order(
        ...
        # Vandermonde = recursivenodes.polynomials.proriolkoornwinderdubinervandermonde(2, 3, nodes, out=None, C=None)
        ...
        Fscale = face_sJ.reshape(-1,face_sJ.shape[-1]) / J[Fmask.flatten('F'), :]
